...
## Generated on : Sun Jun 01 19:55:58 2025
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/BLDC_Controller1_ert_rtw/coderassumptions -I$(START_DIR)/BLDC_Controller1_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/BLDC_Controller1_ert_rtw/coderassumptions/BLDC_Controller1_ca.c
...
%.obj : $(START_DIR)/BLDC_Controller1_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


%.obj : $(START_DIR)/BLDC_Controller1_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
BLDC_Controller1_ca.obj : $(START_DIR)/BLDC_Controller1_ert_rtw/coderassumptions/BLDC_Controller1_ca.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
