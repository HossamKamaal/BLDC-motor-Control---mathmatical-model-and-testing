 ...
 *
 * SIL generated interface for code: "BLDC_Controller1"
 *
 */
...
/* interface data */
boolean_T rtU_hall_signals[3];

/* interface data */
real_T rtU_Emf[3];

/* interface data */
boolean_T rtU_control_signal;
...
static XILIOData xil_fcnid0_task1_y[7];
static XILIOData xil_fcnid0_init_y[7];
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtU_hall_signals[0]);
        ...
        {
          void * dataAddress = (void *) &(rtU_Emf[0]);
        ...
        {
          void * dataAddress = (void *) &(rtU_control_signal);
  ...
  switch (xilTID) {
   case 1:
    ...
    BLDC_Controller1_step(rtM, rtU_hall_signals, rtU_Emf, rtU_control_signal,
                          &(rtY_g1), &(rtY_g2), &(rtY_g3), &(rtY_g4), &(rtY_g5),
                          &(rtY_g6));
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY_g1);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY_g2);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY_g3);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY_g4);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY_g5);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY_g6);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
